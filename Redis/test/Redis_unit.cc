...
int main() {
...

    {
        ...
        std::cout << "Test setKyeLifeTime: "
                  << conn.setKeyLifeTime(kb.c_str(), key.size(), 10)
                  << std::endl;

        // ---
        std::unique_ptr<char[]> temp1(new char[128]);
        Lute::memZero(temp1.get(), 128);
